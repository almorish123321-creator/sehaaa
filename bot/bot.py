...
يدعم استقبال البيانات في رسالة واحدة منسقة + الطريقة التقليدية
"""
...
# دوال طلب البيانات (الطريقة التقليدية)
...
async def ask_admission_date_gregorian(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    message = "📅 يرجى إدخال تاريخ الدخول (ميلادي) - مثال: 20-09-2025"
    keyboard = [[KeyboardButton("الخطوة التالية")]]
    reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True, one_time_keyboard=True)
    await update.message.reply_text(message, reply_markup=reply_markup)
...
async def ask_admission_date_hijri(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    message = "📅 يرجى إدخال تاريخ الدخول (هجري) - أو اضغط الخطوة التالية للتحويل التلقائي"
    keyboard = [[KeyboardButton("الخطوة التالية")]]
    reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True, one_time_keyboard=True)
    await update.message.reply_text(message, reply_markup=reply_markup)
...
async def ask_discharge_date_gregorian(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    message = "📅 يرجى إدخال تاريخ الخروج (ميلادي) - مثال: 21-09-2025"
    keyboard = [[KeyboardButton("الخطوة التالية")]]
    reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True, one_time_keyboard=True)
    await update.message.reply_text(message, reply_markup=reply_markup)
...
async def ask_discharge_date_hijri(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    message = "📅 يرجى إدخال تاريخ الخروج (هجري) - أو اضغط الخطوة التالية للتحويل التلقائي"
    keyboard = [[KeyboardButton("الخطوة التالية")]]
    reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True, one_time_keyboard=True)
    await update.message.reply_text(message, reply_markup=reply_markup)
...
def main() -> None:
    ...
    if not BOT_TOKEN:
        ...
        print("أضف BOT_TOKEN من موقع الاستضافة أو ملف .env")
        print("=" * 50)
        return
    ...
    print("✅ يدعم استقبال البيانات في رسالة واحدة منسقة")
